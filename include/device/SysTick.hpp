...
{
public:
    constexpr static int TickFrequency = 1000;
...
template <typename TFunc>
inline void
SysTickBase::setWaitCompleteCallback(TFunc&& func)
{
 ...
 */
inline void
SysTickBase::startWait(WaitUnitTimeType waitTime, EventLoopCtx)
{
 ...
 */
inline void
SysTickBase::startWait(WaitUnitTimeType waitTime, InterruptCtx)
{
    startWait_BothCtxs(waitTime);
}
 ...
 */
inline bool
SysTickBase::cancelWait(EventLoopCtx)
{
 ...
 */
inline bool
SysTickBase::suspendWait(EventLoopCtx)
{
 ...
 */
inline void
SysTickBase::resumeWait(EventLoopCtx)
{
 ...
 * @return
 */
inline typename SysTickBase::WaitUnitTimeType
SysTickBase::getElapsed(EventLoopCtx) const
{
    return getElapsed_EventLoopCtx();
}

inline void
SysTickBase::nextTick()
{
