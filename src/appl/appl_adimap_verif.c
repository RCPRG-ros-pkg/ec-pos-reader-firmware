...
{
   { 0x1,  "ABP_UINT32",     ABP_UINT32,  1,  APPL_ALL_ACCESS_DESC, { { &appl_lUint32,     &appl_sUint32Prop } },     NULL, NULL, NULL },
   { 0x2,  "ABP_SINT32",     ABP_SINT32,  1,  APPL_ALL_ACCESS_DESC, { { &appl_lInt32,      &appl_sSint32Prop } },     NULL, NULL, NULL },
   { 0x3,  "ABP_UINT16",     ABP_UINT16,  1,  APPL_ALL_ACCESS_DESC, { { &appl_iUint16,     &appl_sUint16Prop } },     NULL, NULL, NULL },
   { 0x4,  "ABP_SINT16",     ABP_SINT16,  1,  APPL_ALL_ACCESS_DESC, { { &appl_iInt16,      &appl_sSint16Prop } },     NULL, NULL, NULL },
   { 0x5,  "ABP_BITS16",     ABP_BITS16,  1,  APPL_ALL_ACCESS_DESC, { { &appl_iBit16,      NULL } },                  NULL, NULL, NULL },
   { 0x6,  "ABP_UINT8",      ABP_UINT8,   1,  APPL_ALL_ACCESS_DESC, { { &appl_bUint8,      &appl_sUint8Prop } },      NULL, NULL, NULL },
   { 0x7,  "ABP_SINT8",      ABP_SINT8,   1,  APPL_ALL_ACCESS_DESC, { { &appl_bInt8,       &appl_sSint8Prop } },      NULL, NULL, NULL },
   { 0x8,  "ABP_UINT8",      ABP_PAD8,    1,  APPL_ALL_ACCESS_DESC, { { NULL,              NULL } },                  NULL, NULL, NULL },
   { 0x9,  "ABP_BIT7",       ABP_BIT7,    1,  APPL_ALL_ACCESS_DESC, { { &appl_bBit8,       NULL } },                  NULL, NULL, NULL },
   { 0x60, "Struct1",        DONT_CARE,   17, APPL_ALL_ACCESS_DESC, { { NULL,              NULL } },                  appl_Adi1Struct, NULL, NULL },
   { 0x70, "Struct2",        DONT_CARE,   17, APPL_ALL_ACCESS_DESC, { { NULL,              NULL } },                  appl_Adi2Struct, NULL, NULL },
   { 0x80, "Enum"   ,        ABP_ENUM,    1,  APPL_ALL_ACCESS_DESC, { { &appl_eEnum,       &appl_sEnumProp } },       NULL, NULL, NULL },
   { 0x81, "Octet_no_map" ,  ABP_OCTET,   1,  APPL_ALL_ACCESS_DESC, { { &appl_bOctet,      &appl_sOctetProp } },      NULL, NULL, NULL },
   { 0x82, "String_no_map",  ABP_CHAR,    6,  APPL_ALL_ACCESS_DESC, { { appl_acString,     NULL } },                  NULL, NULL, NULL },
   { 0x84, "Struct3_no_map", DONT_CARE,   2,  APPL_ALL_ACCESS_DESC, { { NULL,              NULL } },                  appl_Adi3Struct, NULL, NULL },
   { 0x85, "Bit2Array",      ABP_BIT2,    4,  APPL_ALL_ACCESS_DESC, { { &appl_bBit2Array,  NULL } },                  NULL, NULL, NULL },
   { 0x86, "Float"    ,      ABP_FLOAT,   1,  APPL_ALL_ACCESS_DESC, { { &appl_rFloat,      &appl_sFloat32Prop } },    NULL, NULL, NULL },
   { 0x90, "UINT8Array",     ABP_UINT8,   4,  APPL_ALL_ACCESS_DESC, { { appl_bUint8Array,  &appl_sUint8Prop } },      NULL, NULL, NULL },
   { 0x91, "Struct4",        DONT_CARE,   9,  APPL_ALL_ACCESS_DESC, { { NULL,              NULL } },                  appl_Adi4Struct, NULL, NULL },
   { 0x92, "Struct5",        DONT_CARE,   9,  APPL_ALL_ACCESS_DESC, { { NULL,              NULL } },                  appl_Adi5Struct, NULL, NULL },
   { 0x93, "Struct6",        DONT_CARE,   9,  APPL_ALL_ACCESS_DESC, { { NULL,              NULL } },                  appl_Adi6Struct, NULL, NULL },
   { 0x94, "Struct7",        DONT_CARE,   3,  APPL_ALL_ACCESS_DESC, { { NULL,              NULL } },                  appl_Adi7Struct, NULL, NULL }
#if ABCC_CFG_CHECK_STACK_USAGE
